...
function correlationCoefficientGroupedData() {
    ...
    const r = (n * fdxdy - fdx * fdy) / (Math.sqrt(n * fdx2 - fdx * fdx) * Math.sqrt(n * fdy2 - fdy * fdy));
    console.log(fdx);
    console.log(fdx2);
    console.log(fdy);
    console.log(fdy2);
    ...
    console.log(r);
    const resultArea = document.getElementById("data-result-area");
    resultArea.innerHTML = `<p style="text-align: center;"><strong>Pearson's correlation coefficient: ${r}</strong></p>`;
}